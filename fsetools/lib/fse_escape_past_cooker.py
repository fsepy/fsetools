...
def simplified_model(
        ...
        shortest_separation=2.2,
        # shortest separation from hob to a boundary or obstruction [metres] (the boundary is the reason we have to travel _past_ the hob per-se)
    ...
    cumulative_travel = 0
    t = 0
    log = [["time step #", "time [seconds]", "cumulative travel", "separation", "heat received", "tIrad", "FED",
            "cumulative FED"]]
