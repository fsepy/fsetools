...
def example_plot_interflam():
    ...
    plt.savefig(fname="appendix_a_parametric_fire-ec.png", dpi=300)
    plt.show()


def _test_appendix_a_parametric_fire():
...
if __name__ == "__main__":
    ...
    _test_appendix_a_parametric_fire()
