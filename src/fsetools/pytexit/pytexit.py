...
try:
    from fsetools.pytexit.core.core import preprocessing, LatexVisitor, uprint, simplify
    from fsetools.pytexit.core.docx import WordVisitor
    from fsetools.pytexit.core.fortran import for2py
